...
<script type="text/javascript">
  ...
  jQuery(document).ready(function($){
        ...
        mtype:"POST",
	  	height: 250,
	     	...
	     	colModel:[
                ...
                {name:'localname',index:'localname', width:100},
	     		{name:'password',index:'password', width:100,formatter:passwordFormatter},
	     		{name:'username',index:'username', width:50,formatter:mofidyFormatter},
	     		{name:'username',index:'username', width:50,formatter:deleteFormatter},
	  ...
	  function mofidyFormatter(cellvalue, options, rowObject){
          ...
          var link =  jQuery('<a onclick="doUpdateMain(\''+url+'\',\'修改用户信息\');"></a>');
	  ...
	  function passwordFormatter(cellvalue, options, rowObject){
		  ...
		  var link =  jQuery('<a onclick="doShowPassword(\''+cellvalue+'\');"></a>');
          link.text('查看密码');
          link.attr('href','javascript:;');
          return jQuery('<p></p>').append(link).html();
	  }
