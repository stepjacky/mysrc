...
<table width="600" border="1" align="center">
    ...
    <tr>
        ...
        <button name="saveShopper" id="saveShopper">保存店家分类</button>
        </td>
    </tr>
</table>
</form>
...
jQuery(document).ready(function($){	
	...
	var options = { 
		        ...
		        "url": "../model/shoppercatalog.php", // override for form's 'action' attribute 
