...
$href    = $util->getProperty($entry,"href");
...
<table width="600" border="1" align="center">
    ...
    <tr>
        <th colspan="2" bgcolor="#FFFFCC">添加友情链接</th>
    </tr>
    <tr>
     ...
     <tr>
        <td><span style="height: 105px;"><span class="prelabel">友情链接</span></span></td>
        <td><span style="height: 105px;"> <textarea name="href"
            id="href"
            style="float: left; height: 100px; width: 250px;"><?php echo  $href;?></textarea>
        </span></td>
    </tr>
    ...
    <tr>
        ...
        <button name="saveShopper" id="saveShopper">保存链接</button>
        </td>
    </tr>
</table>
</form>
...
var url = "../model/config/"+entryName+".php";
