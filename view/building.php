...
$intro    = $util->getProperty($entry,"intro");
$isStreet = $util->getProperty($entry, "isStreet");
...
<table width="600" border="1" align="center">
    ...
    <tr>
        <th colspan="2" bgcolor="#FFFFCC">添加建筑</th>
    </tr>
    <tr>
    ...
    <tr>
        <td width="141"><span class="prelabel">类型</span></td>
        <td width="443">
            <select name="isStreet">
               <option value="a">街道</option>
               <option value="b">建筑物</option>
               <option value="c">美食圈</option>
               <option value="d">吃环境</option>
               <option value="e">热门菜</option>
    ...
    <tr>
        ...
        <td><span style="height: 105px;"> <textarea name="intro"
            id="intro"
            style="float: left; height: 100px; width: 250px;"><?php echo  $intro;?></textarea>
        </span></td>
    </tr>
    ...
    <tr>
        ...
        <button name="saveShopper" id="saveShopper">保存建筑</button>
        </td>
    </tr>
</table>
</form>
