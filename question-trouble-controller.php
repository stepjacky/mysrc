...
if ($_GET['_search']=="true"){
	...
	if(isset($_GET['qid']))
	{
		$SQL=$SQL . "\t question_id = " .$_GET['qid'] ." and";
		$mark=true;
	}
	if ($mark==true)
...
$SQL = "SELECT id, question_id,email,reason FROM $tableName $sqlconditions ORDER BY $sidx $sord LIMIT $start , $limit"; 
$result = query($SQL);
